/* manifest.js generado desde el panel de administrador — 11/8/2026, 9:21:14 p. m. */
(function () {
  "use strict";
  ...
  window.__BRAND__ = {
    ...
    "settings": {
      ...
      "announcement": "envíos a toda venezuela ✿ pago móvil ✿ personaliza tu franela ✿ nuevos ingresos cada semana",
      "accent": "#ff5fa2",
      "accent2": "#cc00f5",
      "shipping": "Envíos por MRW, Zoom y Tealca a toda Venezuela. Entrega personal en San Carlos sin costo.",
      "payments": "Pago móvil · Transferencia · Zelle · Binance",
      "adminPin": "0000",
    ...
    "products": [
      ...
      {
        "id": "p-002",
        "name": "Paleta de sombras pastel 12 tonos",
        "price": 9,
        "compareAt": 0,
        "category": "maquillaje",
        "emoji": "🎨",
      ...
      {
        "id": "p-007",
        "name": "Collar corazón acero dorado",
        "price": 6,
        "compareAt": 8,
        "category": "accesorios",
        "emoji": "💛",
      ...
      {
        "id": "p-008",
        "name": "Cuaderno tapa dura aesthetic",
        "price": 5,
        "compareAt": 0,
        "category": "papeleria",
        "emoji": "📓",
      ...
      {
        "id": "p-009",
        "name": "Pack 50 stickers surtidos",
        "price": 2,
        "compareAt": 0,
        "category": "papeleria",
        "emoji": "✨",
